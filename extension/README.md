# siimply marketing — Chrome Extension

Companion extension for the siimply marketing app. Captures images and text from any
...
- Right-click an image → "Save image to siimply marketing draft" for one-click capture
