  ...
  return (
    <main className="mx-auto max-w-4xl p-8 space-y-8">
      ...
      <header className="space-y-2">
        ...
        <p className="text-sm text-neutral-500">{t.scheduler.tagline}</p>
      </header>
      ...
      <nav className="grid grid-cols-2 gap-3 md:grid-cols-3">
        {[
          [t.nav.compose, "/tools/scheduler/compose"],
          [t.nav.calendar, "/tools/scheduler/calendar"],
          [t.nav.analytics, "/tools/scheduler/analytics"],
          ["Twitter / X →", "/tools/scheduler/twitter"],
        ].map(([label, href]) => (
          <Link
            key={href}
            href={href}
