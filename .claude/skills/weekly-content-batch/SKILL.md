...
description: Generates 7 days of social posts (Mon-Sun) from a brand brief + product updates. Outputs structured JSON ready to ingest into the miinimal scheduler.
---
